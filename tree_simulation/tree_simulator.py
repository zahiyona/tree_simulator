    ...
    def run(self):
        ...
        for simulation_iteration in simulation_iterations:
            ...
            simulation_iteration.tnt_distance = tnt_tree_comparator.compare(
                simulation_iteration.simulated_tree_path, simulation_iteration.tnt_tree_path,
                simulation_iteration.ntaxa, simulation_iteration.qnum_factor
            )
            ...
            simulation_iteration.clann_distance = clann_tree_comparator.compare(
                simulation_iteration.simulated_tree_path, simulation_iteration.clann_path,
                simulation_iteration.ntaxa, simulation_iteration.qnum_factor
            )

            simulation_iteration.spr_distance = spr_tree_comparator.compare(
                simulation_iteration.simulated_tree_path, simulation_iteration.spr_path,
                simulation_iteration.ntaxa, simulation_iteration.qnum_factor
            )

        for simulation_iteration in simulation_iterations:
            print("taxa: {}, qnum factor: {}, tnt distance: {}".format(
                simulation_iteration.ntaxa, simulation_iteration.qnum_factor, simulation_iteration.tnt_distance))
            print("taxa: {}, qnum factor: {}, maxcut distance: {}".format(
                simulation_iteration.ntaxa, simulation_iteration.qnum_factor, simulation_iteration.maxcut_distance
            ))
            print("taxa: {}, qnum factor: {}, clann distance: {}".format(
                simulation_iteration.ntaxa, simulation_iteration.qnum_factor, simulation_iteration.clann_distance
            ))
            print("taxa: {}, qnum factor: {}, spr distance: {}".format(
                simulation_iteration.ntaxa, simulation_iteration.qnum_factor, simulation_iteration.spr_distance
            ))
